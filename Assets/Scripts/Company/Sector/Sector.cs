...
public class Sector {
    ...
    public void Update(Galaxy branchGalaxy) {
        ...
        exportationTax = exportationTaxPercentage * distance;
    ...
    private void Sell() {
        ...
        float money = productPrice - exportationTax;
    ...
    #region Getters
        ...
        public float GetExportationTax() {
            return exportationTax;
        }
